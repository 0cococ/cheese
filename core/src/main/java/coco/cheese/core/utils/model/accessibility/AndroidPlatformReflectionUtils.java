...
package coco.cheese.core.utils.model.accessibility;
...
public class AndroidPlatformReflectionUtils {
  ...
  private static final String TAG = AndroidPlatformReflectionUtils.class.getSimpleName();
  ...
  private AndroidPlatformReflectionUtils() {}
}
